    ...
    <div class="right-menu">
      <template v-if="device!=='mobile'">
        ...
        <el-tooltip content="源码地址" effect="dark" placement="bottom">
          <ruo-yi-git id="vms-git" class="right-menu-item hover-effect" />
        </el-tooltip>

        <el-tooltip content="文档地址" effect="dark" placement="bottom">
          <ruo-yi-doc id="vms-doc" class="right-menu-item hover-effect" />
        </el-tooltip>
...
import VMSGit from '@/components/VMS/Git'
import VMSDoc from '@/components/VMS/Doc'
