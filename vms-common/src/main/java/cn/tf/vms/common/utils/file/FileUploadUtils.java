package cn.tf.vms.common.utils.file;
...
import cn.tf.vms.common.exception.file.FileNameLengthLimitExceededException;
import cn.tf.vms.common.exception.file.FileSizeLimitExceededException;
import cn.tf.vms.common.exception.file.InvalidExtensionException;
import cn.tf.vms.common.utils.DateUtils;
import cn.tf.vms.common.utils.StringUtils;
import cn.tf.vms.common.utils.uuid.IdUtils;
import cn.tf.vms.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = VMSConfig.getProfile();
    ...
    {
        int dirLastIndex = VMSConfig.getProfile().length() + 1;
